<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CaptainsReport.aspx.cs" Inherits="VolManager.Reports.CaptainsReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        SelectMethod="FetchCaptains" TypeName="NQN.DB.GuidesDM">
        <SelectParameters>
...
<h2 style="color:Black">Shift Captain List</h2></div>
