    ...
    <asp:Login ID="LoginUser" runat="server" EnableViewState="false"    RenderOuterTable="false" OnLoggedIn="SaveUser" OnLoggingIn="OnLoggingIn"  >    
        <LayoutTemplate>       
            ...
            <asp:ValidationSummary ID="LoginUserValidationSummary" runat="server" CssClass="failureNotification"  />
                 ...
                 <asp:Label ID="InstructionText" runat="server" Font-Bold="true" ForeColor="Gray" Text="Please enter your Volunteer ID and password."></asp:Label>
                          
               </div></div>
                     <div class="row">     
                     <div class="col-xs-12">   
                        <asp:Label ID="UserNameLabel" runat="server"   AssociatedControlID="UserName">Volunteer #:</asp:Label>
